...
import com.company.dementiacare.Models.NonDailyMedicine;
import com.company.dementiacare.database.Med;
import com.company.dementiacare.database.MedicineDataLayer;
...
public class MedicineBusinessLayer {
    ...
    public ArrayList<Medicine> getMissedMedicineList() throws ParseException {
        ...
        for (int i = 0; i < medicineDAO.size(); i++) {
            medicineArrayList.add(new Medicine(medicineDAO.get(i)[0].toString(), medicineDAO.get(i)[1].toString(), medicineDAO.get(i)[2].toString(), medicineDAO.get(i)[3].toString(),
                    medicineDAO.get(i)[4].toString(), medicineDAO.get(i)[5].toString(), medicineDAO.get(i)[6].toString(), medicineDAO.get(i)[7].toString()
                    ));
        }
